var emailLabel = $('#loginEmailLabel'), email = $('#loginEmail'), mySVG = $('.svgContainer'), twoFingers = $('.twoFingers'), armL = $('.armL'), armR = $('.armR'), eyeL = $('.eyeL'), eyeR = $('.eyeR'), nose = $('.nose'), mouth = $('.mouth'), mouthBG = $('.mouthBG'), mouthSmallBG = $('.mouthSmallBG'), mouthMediumBG = $('.mouthMediumBG'), mouthLargeBG = $('.mouthLargeBG'), mouthMaskPath = $('#mouthMaskPath'), mouthOutline = $('.mouthOutline'), tooth = $('.tooth'), tongue = $('.tongue'), chin = $('.chin'), face = $('.face'), eyebrow = $('.eyebrow'), outerEarL = $('.earL .outerEar'), outerEarR = $('.earR .outerEar'), earHairL = $('.earL .earHair'), earHairR = $('.earR .earHair'), hair = $('.hair'), bodyBG = $('.bodyBGnormal'), bodyBGchanged = $('.bodyBGchanged');
...
function calculateFaceMove(e) {
	...
	div.textContent = email.val.substr(0, carPos);
	span.textContent = email.val.substr(carPos) || '.';
	div.appendChild(span);
	
	if(document.getElementById('#loginEmail').scrollWidth <= emailScrollMax) {
...
function onEmailFocus(e) {
	activeElement = "email";
	e.parent().attr('class', 'focusWithText');
	//stopBlinking();
	//calculateFaceMove();
	onEmailInput();
}
...
function initLoginForm() {
	...
	email.on('focus', onEmailFocus);
	email.on('blur', onEmailBlur);
	email.on('input', onEmailInput);
	emailLabel.on('click', onEmailLabelClick);
